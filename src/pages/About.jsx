  ...
  return (
    <div>
      ...
      <div className="flex justify-center items-center h-screen">
        <div 
          className="flex items-center bg-ingrain-board-color h-84 w-84 p-36 mt-72 rounded-3xl drop-shadow-2xl"
          style={{
          ...
          <article className="prose lg:prose-xl aesthet_nova text-center">
            <h1 className="aesthet-nova-h1 text-outline-white">The art of crafting cool food</h1>
            <p className="aesthet-nova-h2 pt-12 text-outline-white">
            InGrain. A Brand. A Team. With Passion. To make cool food. For Da Culture.
            </p>
            <p className="aesthet-nova-h2 text-outline-white">
