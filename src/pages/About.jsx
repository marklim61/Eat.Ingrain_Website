  ...
  return (
    <div>
      ...
      <div className='flex justify-center items-center mt-60 bg-ingrain-board-color'>
        <div>
          <p className='aesthet-nova-h2'>Instagram</p>
          <p className='aesthet-nova'>Photo Gallery</p>
          <button className="btn btn-xs sm:btn-sm md:btn-md lg:btn-lg">View More</button>
        </div>
        <div className="carousel carousel-center max-w-md p-4 space-x-4 bg-neutral rounded-box w-screen">
