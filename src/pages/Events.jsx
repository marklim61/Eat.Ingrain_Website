...
const Events = () => {
  return (
    <div className='flex justify-center items-center h-dvh'>
      <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical size-96">
        <li>
          ...
          <div className="timeline-start md:text-end mb-10">
            ...
            <div className="text-lg font-black aesthet-nova">Pure Project Miramar</div>
              <p className='aesthet-nova-h2'>Celebrated Asian American and Pacific Islander Heritage Month. INGRAIN at @puremiramar <br></br>NEW MENU ITEMS & KICK OFF @purebrewing STRAWBERRY FEST RICE, BEER, HERITAGE</p>
          </div>
          <hr/>
        </li>
        <li>
          ...
          <div className="timeline-end mb-10">
            ...
            <div className="text-lg font-black aesthet-nova">Night Parade Brewing Co.</div>
              <p className='aesthet-nova-h2'>First ever plates at @nightparadebrewing</p>
          </div>
          <hr />
        </li>
        <li>
